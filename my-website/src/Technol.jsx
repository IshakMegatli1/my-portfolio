    ...
    <section id="tech" className=" rounded-lg pt-6 pb-10 px-6 bg-[#F4F4F4]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 lg:grid-cols-9 gap-4 items-center justify-items-center">
          ...
          <div className="flex flex-col items-center gap-2 hover:scale-110 transition">
            <img src=".\programmation-vba.jpg" alt="VBA" className="w-8 h-8" />
            <span className="text-sm text-gray-600">VBA</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 hover:scale-110 transition">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" alt="Tailwind" className="w-8 h-8" />
          ...
          <div className="flex flex-col items-center gap-2 hover:scale-110 transition">
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/oracle/oracle-original.svg" alt="Oracle SQL" className="w-8 h-8" />
            <span className="text-sm text-gray-600">Oracle SQL</span>
          </div>
          
          <div className="flex flex-col items-center gap-2 hover:scale-110 transition">
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cf/New_Power_BI_Logo.svg" alt="Power BI" className="w-8 h-8" />
            <span className="text-sm text-gray-600">Power BI</span>
          </div>
